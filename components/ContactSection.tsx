...
export function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="relative w-full overflow-hidden bg-[#F3F3F3] pb-16 pt-10 text-[#181818] lg:pb-24 lg:pt-10"
    >
      <motion.div
      ...
      <div id="contact-media-start-desktop" ref={videoRef} className="relative mt-8 hidden h-[38vw] min-h-[220px] w-full max-h-[560px] overflow-hidden lg:block">
      ...
      <div className="relative mt-2 h-[234px] w-full overflow-hidden lg:hidden">
        <div className="relative isolate h-full w-full">
          <div className="pointer-events-none absolute inset-0 z-0 bg-[#F3F3F3]" aria-hidden />
          <video
      ...
      <div
        ...
        className="relative z-10 mx-auto mt-10 flex w-full max-w-[1440px] flex-col items-center gap-[7px] px-[10px] text-center"
      >
